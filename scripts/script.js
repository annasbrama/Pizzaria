...
$('section.pizza').waypoint(function (direcao) /*direcao = representa um espaço reservado na memoria que irá guardar como o usuário chegou naquele elemento html, as duas possibilidades serão up ou down*/ {
    if (direcao == 'down') {
